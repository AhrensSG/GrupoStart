const FLOWS = {
  ...
  agenda_email: {
    type: "text",
    question: "¿Me pasás tu correo electrónico para registrar la reunión?",
  },
  no_fit: {
  ...
  contenido_email: { type: "text", question: "¿Me compartís tu correo electrónico para enviarte los consejos?" },
  reunion_existente: {
    type: "buttons",
    options: [

...
const Usuario = ({ data }) => {
  ...
  const renderSectionContent = () => {
    switch (selectedSection) {
          ...
          <section ref={perfilRef} className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
              <div className="lg:col-span-2 space-y-4">
                ...
                />
                <button
                  onClick={() => router.push("/user?section=membresia")}
                  className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-white border-2 border-gray-200 hover:border-[#0051FF] hover:text-[#0051FF] rounded-xl text-sm font-semibold text-gray-700 transition-all"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                  </svg>
                  Gestiones de Membresía
                </button>
              </div>
      ...
      case "membresia":
        return <MembershipSection user={data} />;
      case "cursos":

...
*/
    ...
    const handleClick = () => {
        window.open("https://wa.me/+543704619402?text=¡Hola!%20Me%20gustaría%20tener%20una%20asesoria%20sobre", "_blank", "noopener noreferrer");
    };
    ...
    return (
        <main className="flex flex-col md:min-h-screen w-auto xs:h-auto bg-[#0853FC] px-[2%] relative">
            ...
            <div className="absolute inset-0 w-full full -z-8">
                <Image src="/login/Slogo.png" alt="S Logo" fill style={{ objectFit: "cover", opacity: 0.5 }} />
            </div>
            ...
            <section className="flex flex-row px-4 bg-transparent w-1/2 h-1/2 z-20">
                <div className="justify-start items-center px-2 flex-col">
                    <div id="presentacionUser ">
                        <h1 className="text-5xl text-orange-500 font-bold">Hola {userData.nombres}, bienvenido</h1>
            ...
            <div className="flex lg:flex-row md:flex-row sm:flex-row xs:flex-col max-xs:flex-col w-full min-h-screen">
                ...
                <aside className="sm:w-1/4 max-xs:w-full bg-white rounded-xl p-4 h-full sm:sticky top-0 z-20">
                    <ul className="space-y-2 max-xs:grid max-xs:grid-cols-4 xs:grid xs:grid-cols-4 sm:flex-col xs:space-x-0 xs:space-y-0">
                        ...
                        <li
                            className={`p-2 rounded cursor-pointer ${
                                selectedSection === "servicios" ? "bg-blue-500 text-white" : "hover:bg-gray-300"
                            }`}
                        ...
                        <li
                            className={`p-2 rounded cursor-pointer ${
                                selectedSection === "mentoria" ? "bg-blue-500 text-white" : "hover:bg-gray-300"
                            }`}
                    ...
                    <div className="flex justify-center mx-2">
                        ...
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="closeSession" width="42" height="42" className="mr-2">
                                <path
                                    fill="#0853fc"
                                    d="M22,13.75H16a.75.75,0,0,1,0-1.5h6a.75.75,0,0,1,0,1.5Z"
                                    className="color7fbde7 svgShape"
                                ></path>
                                <path
                                    fill="#0853fc"
                                ...
                                <path
                                    ...
                                    className="color232323 svgShape"
                                ></path>
                                <path
                                    fill="#ff6800"
                        ...
                        <div className="fixed inset-0 bg-orange-200 bg-opacity-70 flex items-center justify-center z-50">
                            <div className="bg-white rounded-lg p-6 xs:w-1/3 max-xs:w-full shadow-lg text-center">
                                ...
                                <div className="mt-4 space-x-2">
                                    <button onClick={handleConfirm} className="bg-green-500 text-white px-4 py-2 rounded-md hover:bg-green-600">
                                        Confirmar
                                    </button>

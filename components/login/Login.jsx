...
import { logInWithGoogle } from "@/firebase/logInWithGoogle"; // Asegúrate de que esta ruta sea correcta
import { logInWithFacebook } from "@/firebase/logInWithFacebook"; // Asegúrate de que esta ruta sea correcta
...
const Login = ({ setShowLogin }) => {
    ...
    const handleForgotPassword = () => {
        ...
        toast.info("Funcionalidad de restablecimiento de contraseña no implementada.");
    };
    ...
    const handleTermsClick = () => {
        // Aquí puedes agregar la lógica para mostrar los términos y condiciones
                ...
                <AnimatePresence>
                    ...
                    >
                        <h2 className="text-2xl font-bold text-orange-500 mb-2 text-center">
                            {isRegistering ? "Únete a nosotros hoy" : "Bienvenido de vuelta"}
                        </h2>
                        <p className="text-white text-center font-light">{isRegistering ? "El camino a Impulsar tu Negocio" : "Nos alegra verte otra vez :)"}</p>
                        <br />
                        <div className="flex items-center justify-center mb-4">
                            <span className="text-white font-light">{isRegistering ? "Registrate con:" : "Inicia sesión con:"}</span>
                            <button
                        ...
                        {!isRegistering && (
                            <div className="flex justify-center mb-4">
                                <p className="text-orange-500 text-sm font-semibold cursor-pointer" onClick={handleForgotPassword}>

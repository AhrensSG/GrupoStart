    ...
    return (
        <aside className="relative flex-col w-full bg-white mx-[1%]">
            ...
            <section className="relative bg-[#0853FC] flex w-full py-3 md:pb-12 sm:pb-24 px-[1%] md:flex-row sm:flex-col xs:flex-col max-xs:flex-col">
                <div
                    className="container flex-col pb-2 gap-16 md:ml-1 md:pl-[3%] pt-[55px] md:text-start sm:text-center xs:text-center max-xs:text-center"
                    style={{
                        maxWidth: "1600px",
                        paddingLeft: "3%",
                        paddingRight: "2%",
                ...
                >
                    ...
                    <div className="pt-[20px] gap-16 sm:justify-center">
                        <span className="text-white text-xl w-full sm:text-center">
                            Es tiempo de invertir en tus redes{" "}
                            <span className="hidden md:inline">
                                {" "}
                                <br />
                            </span>
                            para impulsar tu negocio, creación y{" "}
                            <span className="hidden md:inline">
                                {" "}
                                <br />
                            </span>
                            gestión de contenidos que conecten{" "}
                            <span className="hidden md:inline">
                                {" "}
                                <br />
                            </span>
                            con tu audiencia y aumenten la{" "}
                            <span className="hidden md:inline">
                                {" "}
                                <br />
                            </span>
                            visibilidad de tu marca, conocé más en{" "}
                            <span className="hidden md:inline">
                                {" "}
                                <br />
                            </span>
                    ...
                    <div className="py-[30px] sm:justify-center max-xs:justify-items-center">
                        <Link
                            ...
                            target="_blank"
                            className="bg-[#FB8A00] hover:bg-blue-700 text-white font-light py-1 px-4 rounded text-md"
            ...
            <section className="relative flex flex-wrap w-full h-auto justify-center items-center bg-white pb-[10px] px-[2%] bottom-[-160px] md:bottom-[-60px] sm:bottom-[-30px] xs:bottom-[-10px] max-xs:bottom-0 sm:flex-col max-xs:flex-col">
                <div className="flex md:flex-row w-full sm:flex-col xs:flex-col xs:items-center max-xs:flex-col sm:items-center max-xs:items-center">
                    ...
                    <div className="w-full relative flex flex-col md:items-start sm:items-center xs:items-center max-xs:items-center justify-center bg-grey-700 md:pl-[4%]">
                        ...
                        <button
                            className="bg-[#0853FC] hover:bg-[#FB8A00] text-white font-bold md:py-2 sm:py-1 xs:py-1 max-xs:py-1 md:px-4 sm:px-2 xs:px-2 max-xs:px-2 rounded sm:text-2xl xs:text-xl max-xs:text-lg hover:text-[#FFFFFF]  duration-300 shadow-md shadow-black border-orange-500 md:mb-[2%]"
                            onClick={scrollToPlanCards}
                        >
                            Empezar
                        </button>
            ...
            <section className="relative bg-[#FFFFFF] px-[2%] lg:flex-grow md:flex-grow sm:flex-col xs:flex-col max-xs:flex-col">
                <div className="flex md:flex-row w-full bg-[#FFFFFF] md:py-6 lg:py-1 xs:flex-col max-xs:flex-col sm:flex-col">
                    ...
                    <div className="lg:w-full md:w-2/4 relative flex-col xs:items-end max-xs:justify-items-center max-xs:text-center justify-center xs:text-end mt-2 sm:pb-6 xs:pb-8 max-xs:pb-4 lg:pr-[1%] md:pr-[1%] max-xs:px-[2%] md:space-y-2 lg:space-y-4">
                        ...
                        <br />
                        <span className="hidden md:inline md:py-2 md:my-2">
                            {" "}
                            <br />
                        </span>
                        <span className="font-light mb-[40px] text-black xs:text-end max-xs:text-center md:text-md lg:text-xl xl:text-2xl leading-relaxed tracking-wide mt-4">
                            Segmentar y entender a tu audiencia es fundamental{" "}
                            <span className="hidden md:inline">
                                {" "}
                                <br />
                            </span>
                            para crear campañas de marketing efectivas para{" "}
                            <span className="hidden md:inline">
                                {" "}
                                <br />
                            </span>
                            ...
                            Conocer sus edades, intereses, comportamientos y{" "}
                            <span className="hidden md:inline">
                                {" "}
                                <br />
                            </span>
                            necesidades permite diseñar mensajes que realmente{" "}
                            <span className="hidden md:inline">
                                {" "}
                                <br />
                            </span>
                            resuenen e impacten en cada persona, maximizando el{" "}
                            <span className="hidden md:inline">
                                {" "}
                                <br />
                            </span>
                ...
                <div className="flex xs:flex-row max-xs:flex-col w-full lg:-mb-[10%] md:mb-[3%]">
                    ...
                    <div className="w-full relative flex flex-col xs:items-start max-xs:items-center justify-center bg-grey-700 pl-[5%]">
                        ...
                        <span className="xs:text-md md:text-xl sm:text-lg lg:text-2xl md:pb-[5%] xs:text-start max-xs:text-center leading-relaxed tracking-wide font-ligth">
                            Tu biografía es la primera impresión que los
                            posibles{" "}
                            <span className="hidden md:inline">
                                {" "}
                                <br />
                            </span>
                            clientes tienen de tu marca en redes sociales.{" "}
                            <span className="hidden md:inline">
                                {" "}
                                <br />
                            </span>
                            Optimizamos tu diseño y contenido para reflejar la{" "}
                            <span className="hidden md:inline">
                                {" "}
                                <br />
                            </span>
                            identidad de tu marca, asegurando que cada{" "}
                            <span className="hidden md:inline">
                                {" "}
                                <br />
                            </span>
                            publicación contribuya a construir una imagen{" "}
                            <span className="hidden md:inline">
                                {" "}
                                <br />
                            </span>
                ...
                <div className="relative w-full justify-end overflow-hidden bottom-0 ">
                    ...
                    >
                        <path
                            fill="#0853FC"
                            fillOpacity="10"
                            d="M0,160L48,186.7C96,213,192,267,288,277.3C384,288,480,256,576,245.3C672,235,768,245,864,240C960,235,1056,213,1152,186.7C1248,160,1344,128,1392,112L1440,96L1440,320L1392,320L1248,320L1152,320L1056,320L960,320L864,320L768,320L672,320L576,320L480,320L384,320L288,320L192,320L96,320L48,320L0,320Z"
                        ></path>
                    </svg>
                </div>
            </section>
            ...
            <section className="bg-[#0853FC] text-white flex-col justify-items-center py-6 px-[2%]">
                ...
                <div className="text-center justify-center items-center text-2xl md:text-5xl lg:text-5xl">
                    <h2 className="text-[#FFFFFF] font-semibold mt-4">
                        Contratas a Start, contratas un equipo{" "}
                        <span className="hidden md:inline">
                            {" "}
                            <br />
                        </span>
                        de{" "}
                        <span className="text-[#FB8A00] font-semibold">
                            trabajo profesional
                        </span>
                    </h2>
                </div>
                <div className="relative flex justify-center items-center object-center px-[6%] my-6 w-full">
                    <Image
                        ...
                        height={556}
                        quality={100}
                        className="hidden sm:block object-center py-8"
                        priority={true}
                    />
                    <Image
                ...
                <div className="flex relative items-center justify-center text-center mx-[20px] lg:px-[250px] md:px-[10px]">
                    <span className="text-[#FB8A00] text-center justify-center items-center lg:text-4xl md:text-3xl text-light">
                        Contarás con equipo con un mínimo de 7 personas.
                    </span>
                </div>
            </section>
            ...
            <section className="w-full px-[2%] sm:flex-row max-xs:flex-col max-xs:pb-[3%]">
                <div className="flex xs:flex-row max-xs:flex-col md:w-full xs:w-auto bg-[#FFFFFF] px-[2%]">
                    ...
                    <div className="w-full relative flex flex-col xs:items-end xs:justify-end xs:text-end xs:pr-[3%] xs:pb-[8%] max-xs:justify-items-center max-xs:pt-[3vh]">
                        ...
                        <br />
                        <span
                            className="font-light mb-[40px] xs:text-end max-xs:text-center xs:text-lg md:text-3xl leading-relaxed tracking-wide pr-[1%]"
                            style={{ top: -2 }}
                        >
                        ...
                        <Link
                            href={"https://calendly.com/grupostart-ok/30min"}
                            target="_blank"
                            className="bg-[#FB8A00] justify-end hover:bg-blue-700 text-white font-ligth py-1 xs:px-4 max-xs:px-2 rounded max-xs:text-lg xs:text-2xl items-center"
                        >
                            Hablá con un asesor
                        </Link>
                    </div>

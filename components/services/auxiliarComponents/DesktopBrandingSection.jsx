...
const PlanCard = ({ title, features, price, onButtonClick }) => {
  return (
    <div className="bg-[#FFFFFF] shadow-md rounded-lg border border-gray-300 leading-8 h-[556px] w-[307px] relative container flex flex-col pb-1">
      ...
      <ul className="list-none pl-[33px] pr-[12px] py-[8px] h-[216px] w-[300px] flex-grow justify-center relative">
        {" "}
        {/* Changed list style for spacing */}
        {features.map((feature, index) => (
          <li
            key={index}
            className="flex items-center text-center justify-center mb-3"
          >
            {feature}
...
const DesktopBrandingSection = () => {
  ...
  return (
    <div
      className="py-8 px-[4%] w-full flex-row xs:px-0 sm:px-0"

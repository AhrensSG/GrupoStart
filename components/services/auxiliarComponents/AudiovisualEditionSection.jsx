...
const AudiovisualEditionSection = () => {
  return (
    <div className="w-full flex flex-col justify-center items-center gap-16 py-20">
      <h1 className="text-4xl font-medium">Edición audiovisual</h1>
      <p className="text-2xl text-center font-medium max-w-xl text-[#0853FC]">
        Logra que tus videos tengan un gran alcance
      </p>
      <h2 className="text-4xl font-medium">Trabajemos juntos</h2>
          ...
          <div className="w-full flex flex-col justify-between items-center gap-6 p-4">
            <div className="w-full space-y-4">
              <div className="w-full flex flex-col justify-center items-center gap-4">
                ...
                <span className="cursor-default text-transparent text-4xl font-medium">
                  $ 00.000
                </span>
              </div>
              <div className="flex flex-col justify-center items-start gap-3">
      ...
      <button className="bg-white border border-[#0853FC] p-2 px-6 text-[#0853FC] shadow-md shadow-[#0853FC] hover:shadow-lg hover:shadow-[#0853FC] duration-500 font-medium rounded-md">QUIERO UN PLAN PERSONALIZADO</button>
    </div>
  );
};

export default AudiovisualEditionSection;

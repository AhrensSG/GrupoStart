...
const DesktopTemplate = ({ children, media = "/MediaPlayer.svg", icon = "/services/Jirafe4.svg", footerImg = "/services/FooterJirafe1.svg" }) => {
    return (
        <main
        ...
        >
            <Toaster richColors visibleToasts={3} duration={5000} position="bottom-right" expand={false} />
            ...
            {/* Plans */}
            <section className="w-full h-full flex flex-col justify-center items-center">{children}</section>
            {/* Footer */}
            <Footer />
        </main>
    );

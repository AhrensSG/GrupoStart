...
const InfoViewMore = () => {
    return (
    <section className="relative flex flex-wrap w-auto h-screen justify-center items-center bg-white bg-gradient-to-b">
    ...
    {/*Ola*/}
    <div className="wave absolute h-0 w-full bg-[#0853FC] inset-x-0 my-0 bottom-auto object-cover">

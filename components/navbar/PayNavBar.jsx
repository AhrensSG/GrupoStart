        ...
        <nav className="bg-[#EEEEEE] flex items-center p-4 z-30 w-full">
            ...
            <div className="flex flex-col md:items-center md:mt-6">
                ...
                <button
                    ...
                    className="text-gray-500 flex items-center text-sm mt-6 font-bold hover:text-gray-800"
                >
                    <svg
            ...
            <div className="flex-1 flex justify-center md:hidden">
                <div className="flex items-center">
                    ...
                    <h2 className="font-bold text-lg ml-2 whitespace-nowrap">
                        Mi Compra
                    </h2>
                </div>
            </div>
            ...
            <div className="hidden md:flex flex-1 items-center justify-between">
                ...
                <div>
                    <button
                        ...
                        className="text-lg underline mx-4"
                    >
                        Seguir comprando
                    </button>
                </div>
            ...
            <div className="ml-auto flex flex-col md:flex-row md:items-center gap-2 md:gap-6">
                ...
                <Link href={state.user ? "/user" : "/login"}>
                    <button
                        className={`w-10 h-10 flex items-center justify-center border rounded-tl-xl rounded-br-xl text-center shadow-md border-orange-500 duration-300 bg-orange-500 text-white shadow-orange-500 hover:bg-white hover:text-orange-500`}
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="20"

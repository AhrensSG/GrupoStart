      ...
      <div className="relative bg-white rounded-2xl shadow-xl border border-gray-100 w-full max-w-5xl max-h-[calc(100vh-4rem)] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div>
            ...
            <div className="hidden md:grid grid-cols-[80px_3fr_100px_1fr_120px_85px] gap-2 px-3 py-2 mb-1">
            ...
            <div className="space-y-1.5">
              {rounds.map((r, i) => {
                ...
                return (
                  <div key={i} className="grid grid-cols-1 md:grid-cols-[80px_3fr_100px_1fr_120px_85px] gap-2 p-3 bg-gray-50 rounded-xl items-start">
                    ...
                    <div><input type="text" value={r.fecha} readOnly={!r.clasificacion || r.clasificacion === "Pendiente"} placeholder="dd/mm/aaaa" className={`w-full px-2.5 py-2 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#0051FF]/20 focus:border-[#0051FF] ${!r.clasificacion || r.clasificacion === "Pendiente" ? "bg-gray-100 text-gray-400 cursor-not-allowed" : "bg-white border-gray-200"}`}/></div>

        ...
        <div className="border-b border-gray-200">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 h-12 sm:h-14 flex items-center justify-between">
            <div className="flex items-center gap-1 sm:gap-2 min-w-0">
              ...
              <span className="font-semibold text-gray-900 text-sm sm:text-base truncate">base de datos de {profile?.company_name || user?.name?.split(" ")[0] || user?.email || "GrupoStart Tools"}</span>
              <div className="hidden md:flex items-center gap-1 ml-4 pl-4 border-l border-gray-200">
                ...
                {user?.role === "admin" && (
                  <Link href="/tools/whatsapp" className="px-2.5 py-1.5 text-xs text-gray-400 hover:text-[#25D366] hover:bg-green-50 rounded-lg transition-colors flex items-center gap-1">
          ...
          <div className="md:hidden border-t border-gray-100 overflow-x-auto scrollbar-none">
            <div className="flex items-center gap-1 px-3 py-1.5 min-w-max">
              <button onClick={() => setViewMode("active")} className={`px-2.5 py-1.5 text-xs rounded-lg whitespace-nowrap transition-colors ${viewMode === "active" ? "text-[#0051FF] bg-blue-50 font-semibold" : "text-gray-400 hover:text-[#0051FF] hover:bg-blue-50"}`}>
                Contactos
              </button>
              <Link href="/tools/estadistica" data-tut="link-estadistica" className="px-2.5 py-1.5 text-xs text-gray-400 hover:text-[#0051FF] hover:bg-blue-50 rounded-lg whitespace-nowrap transition-colors">
                Estadística
              </Link>
              <Link href="/tools/tutoriales" data-tut="link-tutoriales" className="px-2.5 py-1.5 text-xs text-gray-400 hover:text-[#0051FF] hover:bg-blue-50 rounded-lg whitespace-nowrap transition-colors">
                Tutoriales
              </Link>
              <Link href="/tools/copys" data-tut="link-copys" className="px-2.5 py-1.5 text-xs text-gray-400 hover:text-[#0051FF] hover:bg-blue-50 rounded-lg whitespace-nowrap transition-colors flex items-center gap-1">
                <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
                  <rect x="3" y="8" width="18" height="4" rx="1" />
                  <path d="M12 8v13" />
                  <path d="M19 12v7a2 2 0 01-2 2H7a2 2 0 01-2-2v-7" />
              ...
              {user?.role === "admin" && (
                <Link href="/tools/whatsapp" className="px-2.5 py-1.5 text-xs text-gray-400 hover:text-[#25D366] hover:bg-green-50 rounded-lg whitespace-nowrap transition-colors flex items-center gap-1">
                  <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M12.04 2a9.91 9.91 0 00-8.52 14.92L2 22l5.25-1.48A9.9 9.9 0 1012.04 2zm0 18.09a8.1 8.1 0 01-4.14-1.13l-.3-.18-3.11.88.85-3.03-.2-.31a8.14 8.14 0 116.9 3.77zm4.46-6.08c-.24-.12-1.44-.71-1.66-.79-.22-.08-.39-.12-.55.12-.16.24-.63.79-.77.95-.14.16-.28.18-.53.06a6.65 6.65 0 01-3.31-2.9c-.25-.43.25-.4.72-1.33.08-.16.04-.3-.02-.42-.06-.12-.55-1.32-.75-1.81-.2-.48-.4-.41-.55-.42h-.47c-.16 0-.42.06-.64.3-.22.24-.84.82-.84 2s.86 2.32.98 2.48c.12.16 1.69 2.58 4.1 3.62.57.25 1.02.4 1.37.51.57.18 1.09.16 1.5.1.46-.07 1.44-.59 1.64-1.16.2-.57.2-1.06.14-1.16-.06-.1-.22-.16-.46-.28z" />
                  </svg>
                  WhatsApp
              ...
              <Link href="/user" data-tut="link-perfil" className="px-2.5 py-1.5 text-xs text-gray-400 hover:text-[#0051FF] hover:bg-blue-50 rounded-lg whitespace-nowrap transition-colors">
                Perfil
              </Link>
              <button data-tut="link-papelera" onClick={() => { setViewMode("trash"); fetchTrash() }} className={`px-2.5 py-1.5 text-xs rounded-lg whitespace-nowrap transition-colors ${viewMode === "trash" ? "text-red-500 bg-red-50 font-semibold" : "text-gray-400 hover:text-red-500 hover:bg-red-50"}`}>
                Papelera
              </button>
            </div>
          </div>

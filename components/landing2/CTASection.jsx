          ...
          <div className="bg-[#0F1512] border border-[#2A3035] rounded-2xl p-8 max-w-md mx-auto text-left space-y-4">
            ...
            <div className="pt-4 space-y-3">
              ...
              <a
                ...
                className="w-full flex items-center justify-center gap-2 px-4 py-3 border border-[#00F74C]/40 text-[#00F74C] hover:bg-[#00F74C]/10 rounded-xl text-sm font-bold transition-colors"

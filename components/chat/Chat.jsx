...
const Chat = () => {
  ...
  return (
    <>
      {/* Floating Button */}
      <div className="fixed bottom-4 z-30 flex flex-col items-center xs:space-y-4 max-xs:space-y-2 right-4 sm:right-0 md:right-10 lg:right-11 xl:right-12 sm:left-auto">

                    ...
                    <div className="max-xs:w-full top-10 xs:w-full">
                        <div className="bg-white shadow-md shadow-[#0853FC]/40 p-4 border border-[#0853FC] rounded-md">
                            <div className="text-xl font-normal flex flex-row justify-between w-full">
                                <span>SUBTOTAL:</span>
                                <span> $ {state?.cartPrice ? state.cartPrice : state?.cart?.reduce((acc, curr) => acc + curr.price, 0) || 0}</span>
                            </div>
                            <div className="text-xl font-normal flex flex-row justify-between w-full">
                                <span>IVA 21%:</span>
                                <span>
                                    {" "}
                                    ${" "}
                                    {state?.cartPrice ? state.cartPrice * 0.21 : state?.cart?.reduce((acc, curr) => acc + curr.price, 0) * 0.21 || 0}
                                </span>
                            </div>
                            <div className="text-xl font-medium flex flex-row justify-between w-full">
                                ...
                                <span>
                                    ...
                                    ${" "}
                                    {state?.cartPrice
                                        ? state.cartPrice + state.cartPrice * 0.21
                                        : state?.cart?.reduce((acc, curr) => acc + curr.price, 0) * 1.21 || 0}
                                </span>
                            </div>
                        </div>
                    </div>

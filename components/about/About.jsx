...
const About = () => {
    return (
        <aside className="w-full relative flex flex-col justify-start items-center overflow-hidden">
            ...
            <Chat />
            {/* Section 1 */}
            <section className="relative bg-[#0853FC] flex w-full px-[2%] justify-items-center flex-col md:leading-0 sm:leading-relaxed xs:leading-tigh max-xs:leading-tigh">
                {/* Sección de texto y botón */}
                <div className="w-full relative flex flex-col justify-center items-center text-center py-3">
                    <span className="lg:text-5xl md:text-3xl xs:text-2xl font-bold text-[#FB8A00] text-center justify-center items-center relative leading-snug">
                        ...
                        nuestra historia, objetivos, filosofía,{" "}
                        <span className="hidden md:inline">
                            {" "}
                            <br />
                        </span>
                    ...
                    <br />
                    <span className="lg:text-2xl sm:text-lg xs:text-md text-white text-center flex-col justify-center items-center relative lg:w-auto md:w-auto md:px-0 sm:h-auto sm:px-[5%] md:leading-0 max-xs:leading-relaxed xs:leading-relaxed sm:leading-relaxed">
                        Somos una agencia de marketing completa de 360 grados,{" "}
                        <span className="hidden md:inline">
                            {" "}
                            <br />
                        </span>
                        enfocada en conectar a los negocios al mundo digital y
                        generar{" "}
                        <span className="hidden md:inline">
                            {" "}
                            <br />
                        ...
                        <br />
                        Pensamos la estrategia adecuada, creamos contenidos,{" "}
                        <span className="hidden md:inline">
                            {" "}
                            <br />
                        </span>
                        publicidad efectiva, imágenes y videos profesionales,
                        estamos en{" "}
                        <span className="hidden md:inline">
                            {" "}
                            <br />
                        </span>
                        varios países ayudando a negocios de todos los niveles,{" "}
                        <span className="hidden md:inline">
                            {" "}
                            <br />
                        </span>
                        desde emprendedores hasta empresarios corporativos.{" "}
                        <span className="hidden md:inline">
                            {" "}
                            <br />
                        </span>
            ...
            <section className="bg-[#FFFFFF] w-full flex flex-col items-center justify-center">
                <h3 className="lg:text-3xl sm:text-xl max-xs:text-lg font-light text-black justify-center text-center items-center">
                    Historia
                </h3>
                <h2 className="lg:text-5xl md:text-3xl max-xs:text-xl font-bold mb-8 text-[#FB8A00]">
                    Así nació Start
                </h2>
                ...
                <div className="relative w-full max-w-6xl">
                    ...
                    <div className="w-full flex justify-between items-center mb-16 xs:px-[4%] md:px-0">
                        <div className="lg:w-1/2 md:w-1/3 xs:w-[18vh] flex flex-col items-center text-right lg:pr-10 md:pr-0 md:pl-16">
                            ...
                            />
                            <p className="xs:text-2xl max-xs:text-lg font-bold mt-4">
                                Ivan E. Ayala
                            </p>
                ...
                <div className="flex flex-col h-auto md:items-start lg:justify-center md:text-start pt-7 relative lg:w-[100%] md:pl-0 md:w-[90%] md:justify-start lg:left-[13.5%] md:mt-[8vh] md:mr-[4vh] sm:left-0 xs:items-center xs:text-center max-xs:items-center max-xs:text-center mx-1">
                    ...
                    <span className="lg:block max-xs:px-[1%] xs:px-[2%] leading-relaxed text-black lg:text-xl md:text-lg xs:text-lg md:text-start xs:text-center justify-center md:items-start xs:items-center max-xs:items-center max-xs:text-center xl:ml-[0%] lg:w-2/3 lg:pr-[16%] md:w-[45vh] md:mr-[8%] relative lg:left md:flex-grow md:justify-between md:static">
                        Start se fundó en Formosa Argentina a comienzos del año
                        2023,{" "}
                        <span className="hidden md:inline">
                            {" "}
                            <br />
                        </span>
                        aunque nuestra historia comienza mucho antes con el
                        objetivo de{" "}
                        <span className="hidden md:inline">
                            {" "}
                            <br />
                        </span>
                        erradicar uno de los problemas más grandes presentes en
                        todos{" "}
                        <span className="hidden md:inline">
                            {" "}
                            <br />
                        ...
                        los negocios:{" "}
                        <strong>
                            "la desinformación sobre los beneficios de las{" "}
                            <span className="hidden md:inline">
                                {" "}
                                <br />
                            </span>
                            herramientas del mundo digital".
                        </strong>{" "}
                        <span className="hidden md:inline">
                            {" "}
                            <br />
                    ...
                    <div className="lg:w-full md:w-[95%] py-[2vh] flex flex-col md:flex-row items-start justify-center md:text-end xs:text-center max-xs:text-center lg:px-4">
                        ...
                        <div className="hidden md:block lg:pl-6 md:pl-6 lg:w-2/4 lg:h-full md:w-1/3 md:h-1/4 xs:w-[2vh] xs:h-[2vh]">
                            <svg
                                ...
                                height="147"
                                xmlns="http://www.w3.org/2000/svg"
                                className="lg:mr-0 md:-mr-2  lg:w-[35vh] md:w-[7vh] xs:w-[2vh]"
                                style={{ top: 250, bottom: -180 }}
                            >
                                <path
                                    d="M0 0 L0 147 L310 147"
                                    stroke="#0853FC"
                                    strokeWidth="5"
                                    fill="none"
                                />
                        ...
                        <div className="lg:w-full md:pl-6 pt-6 lg:pl-0 xs:px-[2%] max-xs:px-[1%]">
                            <span
                                className=" md:text-end xs:text-center max-xs:text-center justify-center md:items-end xs:items-center max-xs:items-center lg:text-xl xs:text-lg leading-relaxed"
                                style={{ top: 500, bottom: -70 }}
                            >
                                Culminaba la pandemia del covid-19 que tanto
                                afligió al{" "}
                                <span className="hidden md:inline">
                                    {" "}
                                    <br />
                                </span>
                                mundo, Iván organizaba un evento de
                                entretenimiento{" "}
                                <span className="hidden md:inline">
                                    {" "}
                                    <br />
                                </span>
                                y relaciones públicas, en ese momento se
                                encontraba{" "}
                                <span className="hidden md:inline">
                                    {" "}
                                    <br />
                                </span>
                                cursando la carrera de comercio exterior y ya
                                creaba{" "}
                                <span className="hidden md:inline">
                                    {" "}
                                    <br />
                                </span>
                                contenido para varios clientes locales
                                reconocidos{" "}
                                <span className="hidden md:inline">
                                    {" "}
                                    <br />
                        ...
                        <div className="flex max-xs:flex-col xs:flex-col md:flex-row lg:justify-between xs:justify-center lg:w-full md:w-[83%] xs:text-center xs:justify-items-center">
                            ...
                            <div className="lg:w-3/4 max-md:w-[33%] min-md:w-[25%] sm:w-full xs:w-full max-xs:w-full max-xs:justify-items-center max-xs:text-center xs:items-center xs:text-center xs:justify-center md:text-start md:items-start">
                                <span className="lg:text-xl xs:text-lg leading-relaxed md:text-start xs:text-center max-xs:text-center justify-center md:items-start xs:items-center max-xs:items-center">
                                    Seba, un diseñador gráfico y publicista con
                                    una amplia trayectoria,{" "}
                                    <span className="hidden md:inline">
                                        {" "}
                                        <br />
                                    </span>
                                    estaba de pasada para saludar al dueño del
                                    lugar, nota la presencia{" "}
                                    <span className="hidden md:inline">
                                        {" "}
                                        <br />
                                    </span>
                                    de varios influencers, se acercó preguntando
                                    por el organizador,{" "}
                                    <span className="hidden md:inline">
                                        {" "}
                                        <br />
                                    </span>
                                    y así fue como se encontró con Iván y le
                                    propuso sus servicios de{" "}
                                    <span className="hidden md:inline">
                                        {" "}
                                        <br />
                                    </span>
                                    marketing para el evento a cambio de que los
                                    influencers hicieran{" "}
                                    <span className="hidden md:inline">
                                        {" "}
                                        <br />
                                    </span>
                                    unas fotos con los sombreros que él estaba
                                    promoviendo.{" "}
                                    <span className="hidden md:inline">
                                        {" "}
                                        <br />
                                    </span>
                                    Iván aceptó la colaboración y al final de la
                                    sesión terminó{" "}
                                    <span className="hidden md:inline">
                                        {" "}
                                        <br />
                                    </span>
                                    comprando un sombrero que hasta hoy lo
                                    conserva. Seba{" "}
                                    <span className="hidden md:inline">
                                        {" "}
                                        <br />
                                    </span>
                                    promocionó el evento con amigos y con
                                    publicidad paga en redes{" "}
                                    <span className="hidden md:inline">
                                        {" "}
                                        <br />
                                    </span>
                                    sociales logrando atraer un gran número de
                                    personas al evento.{" "}
                                    <span className="hidden md:inline">
                                        {" "}
                                        <br />
                                    ...
                                    <strong>
                                        La sinergia entre ambos fue tan evidente
                                        que luego de un{" "}
                                        <span className="hidden md:inline">
                                            {" "}
                                            <br />
                                        </span>
                                        tiempo deciden trabajar juntos en un
                                        proyecto más grande{" "}
                                        <span className="hidden md:inline">
                                            {" "}
                                            <br />
                                        </span>
                                        como socios, fundando lo que hoy
                                        conocemos como Grupo Start.
                                    </strong>{" "}
                                    <span className="hidden md:inline">
                                        {" "}
                                        <br />
                            ...
                            {/* SVG para MD y mayores */}
                            <div
                                className="hidden md:block lg:w-1/4 md:w-1/4"
                            ...
                            >
                                <svg
                                    ...
                                    height="202"
                                    xmlns="http://www.w3.org/2000/svg"
                                    className="lg:ml-0 min-md:pl-[-10vh] max-md:ml-[-2vh]"
                                    style={{ top: -50, bottom: 90 }}
                                >
                                    <path
                                        d="M97 0 L97 202 L0 203"
                                        stroke="#0853FC"
                                        strokeWidth="6"
                                        fill="none"
                                    />
                ...
                {/* Ola */}
                <div
                    className="relative w-full justify-end bottom-0"
                    style={{ paddingTop: -35 }}
                >
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
            ...
            <section className="bg-[#0853FC] w-full py-8">
                <div className="flex flex-col items-center justify-center relative px-8">
                    ...
                    <div className="w-full flex flex-col xs:items-start max-xs:items-center max-xs:text-center xs:text-end mb-12 max-w-[850px] relative">
                        ...
                        <div className="bg-white text-[#0853FC] font-light xs:text-xl p-8 mt-4 rounded-lg shadow-md w-full h-auto">
                            <p className="lg:text-[1.5rem] xs:text-xl font-light leading-relaxed text-start">
                                Estudié comercio exterior y emprendo desde los
                                18 años. Lidero con pasión el área de Community
                                Managers en Grupo Start, donde mi mayor talento
                                radica en crear estructuras de trabajo
                                funcionales que optimicen los procesos
                                contemplando a las personas y sus talentos.
                                <br />
                                Siempre impulso a mi equipo y a mis clientes a
                                alcanzar nuevas alturas, integrando la
                                tecnología y la innovación en cada estrategia.{" "}
                                <br />
                                Creo firmemente que alinear nuestras pasiones
                                con nuestras tareas diarias es el camino hacia
                    ...
                    <div className="w-full flex flex-col xs:items-start xs:text-start max-xs:text-center max-xs:items-center max-w-[850px] relative">
                        ...
                        <div className="bg-white text-[#0853FC] font-light xs:text-xl p-8 mt-4 rounded-lg shadow-md w-full h-auto">
                            <p className="lg:text-[1.5rem] xs:text-xl font-light leading-relaxed text-start">
                                Visionario emprendedor, diseñador gráfico y
                                publicista con amplia trayectoria en la
                                industria, lidero y coordino con éxito las áreas
                                de diseño gráfico, marketing y ventas.
                                <br />
                                Apasionado por la innovación y el crecimiento,
                                “hacer que suceda” es mi frase favorita,
                                colaboré con marcas en su identidad y expansión,
                                también con autores en el lanzamiento de sus
                                libros, creo firmemente en el trabajo en equipo,
                                estoy activamente para lograr brindar un
                                servicio de calidad.
                            </p>
                        </div>
                    </div>
            ...
            <section className="bg-[#0853FC] w-full lg:py-8 xs:py-4 max-xs:py-4 px-[2%]">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-white lg:text-2xl xs:text-lg font-light mt-2 px-[50px]">
                        Si tu compromiso con tu negocio es total, llegaste al
                        lugar correcto, esta vez si vas{" "}
                        <span className="hidden md:inline">
                            {" "}
                            <br />
                        </span>
                        a conseguir resultados, no te vamos a prometer que sean
                        inmediatos pero sí{" "}
                        <span className="hidden md:inline">
                            {" "}
                            <br />
                        </span>
                        sostenibles y exponenciales.{" "}
                        <span className="hidden md:inline">
                            {" "}
                            <br />
                        </span>
                        <br />
                        Somos tu equipo profesional y queremos acompañar a tu
                        negocio en cada etapa.{" "}
                        <span className="hidden md:inline">
                            {" "}
                            <br />
                        </span>
                ...
                <div className="flex justify-center lg:gap-[32px] xs:gap-[10px] md:mb-16 xs:mb-2 max-xs:mb-3 md:pb-[80px] xs:pb-1">
                    <div className=" flex xs:flex-row max-xs:flex-col items-center">
                        <div className="bg-white rounded-full lg:px-[70px] sm:px-[35px] xs:px-[28px] max-xs:px-auto lg:py-2 md:py-1 text-[#FB8A00] font-bold text-center xs:text-auto max-xs:text-auto lg:text-[1.5vh] xl:text-[2.25vh]">
                            1 - Desarrollo
                        </div>
                    </div>
                ...
                <div className="flex flex-wrap md:flex-nowrap justify-center lg:gap-[5px] md:gap-[1px] md:mb-16 xs:my-8 md:my-4">
                    ...
                    <div className="bg-[#FB8A00] rounded-lg lg:w-[270px] md:w-[240px] md:h-auto w-full flex md:flex-col xs:flex-row md:items-center p-4 mb-4 md:mb-0 relative">
                        ...
                        <div className="md:mt-8 md:mb-auto md:text-center sm:text-left xs:p-2 max-xs:p-1 md:p-0">
                            ...
                            <p className="text-white font-light mt-4 leading-relaxed lg:text-xl md:text-xl xs:text-lg">
                                Nos esforzamos por alcanzar los{" "}
                                <span className="hidden md:inline">
                                    {" "}
                                    <br />
                                </span>
                                ...
                                la estrategia, el equipo hasta la{" "}
                                <span className="hidden md:inline">
                                    {" "}
                                    <br />
                                </span>
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-white lg:text-2xl xs:text-lg font-light mt-4 px-4">
                        Los procesos de desarrollo requieren que se deleguen
                        ciertas{" "}
                        <span className="hidden md:inline">
                            {" "}
                            <br />
                        </span>
                        actividades, somos el equipo que estás buscando y el que{" "}
                        <span className="hidden md:inline">
                            {" "}
                            <br />
                        </span>
                    ...
                    <p className="text-white lg:text-2xl xs:text-lg font-light mt-2 px-4">
                        Años de experiencia nos permitieron encontrar la receta
                        para{" "}
                        <span className="hidden md:inline">
                            {" "}
                            <br />
                ...
                <div className="text-center">
                    <Link
                        ...
                        target="_blank"
                        className="bg-orange-500 hover:bg-orange-600 text-white font-light lg:py-3 lg:px-[40px] xs:py-1 xs:px-[20px] max-xs:px-2 rounded-lg lg:text-2xl xs:text-lg"
                    >
                        Hablá con un asesor
                    </Link>
                </div>
                ...
                <div className=" flex md:flex-row xs:flex-col max-xs:flex-col items-center justify-center lg:gap-8 lg:pl-[80px]">
                    ...
                    <div className="w-full text-white xs:text-center max-xs:text-center max-xs:px-1 md:text-end lg:pr-[7%] md:pr-[1%] xs:pr-0">
                        ...
                        <p className="lg:text-2xl xs:text-lg font-light leading-relaxed">
                            Lograremos que hayan sucursales en{" "}
                            <span className="hidden md:inline">
                                {" "}
                                <br />
                            </span>
                            todo América y porque no permitirse{" "}
                            <span className="hidden md:inline">
                                {" "}
                                <br />
                            </span>
                            soñar ¡En todo el mundo!{" "}
                            <span className="hidden md:inline">
                                {" "}
                                <br />
                            </span>
                            La clave para hacer de Start una{" "}
                            <span className="hidden md:inline">
                                {" "}
                                <br />
                            </span>
                            empresa eficiente fue la{" "}
                            <span className="hidden md:inline">
                                {" "}
                                <br />
                            </span>
                            comunicación, lo sabemos, tenemos{" "}
                            <span className="hidden md:inline">
                                {" "}
                                <br />
                            </span>
                            el sistema adecuado y los recursos{" "}
                            <span className="hidden md:inline">
                                {" "}
                                <br />
                            </span>
                            humanos más capacitados para{" "}
                            <span className="hidden md:inline">
                                {" "}
                                <br />
                            </span>
            ...
            <section className="bg-[#0853FC] w-full py-8 px-[2%]">
                ...
                <div className="text-center">
                    <p className="text-white lg:text-3xl xs:text-2xl font-light leading-relaxed max-w-5xl mx-auto">
                        La coordinación no será una dificultad y sabemos elegir
                        a los mejores{" "}
                        <span className="hidden md:inline">
                            {" "}
                            <br />
                        </span>
                        para garantizar los resultados. Pronto incursionaremos
                        además en las{" "}
                        <span className="hidden md:inline">
                            {" "}
                            <br />
                        </span>
                        finanzas, proyectos tecnológicos, cursos de
                        capacitación, encuentros{" "}
                        <span className="hidden md:inline">
                            {" "}
                            <br />
                        </span>
                        sociales, exposiciones y mucho más, esto dejará de ser
                        un sueño.{" "}
                        <span className="hidden md:inline">
                            {" "}
                            <br />
                        </span>
                        Sabemos que el límite lo ponemos nosotros y no es algo
                        que hayamos{" "}
                        <span className="hidden md:inline">
                            {" "}
                            <br />
            ...
            <section className="bg-[#0051FF] text-white xs:p-6 max-xs:px-[2%] lg:w-full relative">
                ...
                <div className="flex relative items-center justify-center text-center lg:mx-[60px] lg:px-[270px] md:px-[240px] py-8">
                    <Link
                        href={"https://calendly.com/grupostart-ok/30min"}
                        target="_blank"
                        className="bg-[#FB8A00] hover:bg-blue-700 text-white font-light py-1 xs:px-4 max-xs:px-2 rounded lg:text-2xl xs:text-lg"
                    >

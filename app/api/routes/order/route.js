...
import { requireUser, requireAdmin, unauthorizedResponse } from "@/lib/auth/server";
...
export async function POST(req) {
  try {
    ...
    const { status, totalPrice, deliveryCost, cartPrice, email, name, surname, postalCode, country, province, fullAddress, phone } =
      await req.json();

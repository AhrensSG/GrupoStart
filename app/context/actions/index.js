...
const SERVER_URL_ORDER_PRODUCTS_ENDPOINT = process.env.NEXT_PUBLIC_SERVER_ORDER_PRODUCTS_ENDPOINT;

////////////////////////// PAYMENT //////////////////////////////////

const SERVER_URL_DELIVERY_COST_ENDPOINT = process.env.NEXT_PUBLIC_SERVER_DELIVERY_COST_ENDPOINT;

const SERVER_URL_CREATE_PAYMENT_ENDPOINT = process.env.NEXT_PUBLIC_SERVER_CREATE_PAYMENT_ENDPOINT;
...
export const createPayment = async (user, productsCart, deliveryCost, orderId) => {
    try {
        ...
        const pay = await axios.post(`${SERVER_URL_CREATE_PAYMENT_ENDPOINT}`, paymentData, { maxBodyLength: Infinity });
        return pay.data;
    } catch (error) {
        throw new Error("Error interno del servidor");
    }
